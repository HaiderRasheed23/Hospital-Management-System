//Hospital Management System .....By HAIDER RASHEED
#include<iostream>
#include<fstream>
#include<cstdlib>
#include<conio.h>
...
//NOTE: PLEASE RUN THE PROGRAM IN FULL SCREEN ONLY

{
	system("color 02");
	cout<<endl<<endl<<endl;
	cout<<"\n\n\n\n\n\n\n\n\n\n\t\t\t              HAIDER RASHEED (14454)  ";
	char x= 219;
...
if(i==4)
{
	...
	file.open("hospital.txt");
		...
		{
		    cout<<"\n\n\n\n\n\n\n\t\t\t\t\t   ...........................Information about the Services Hospital.............................\n\n";
		    string line;
			while(file.good())
			{
			getline(file,line);
...
if(i==2)
{
    ...
    gets(firstname);
    system("cls");
	pat_file.open(firstname, ios::in);
		if(!pat_file)
		{
		cout<<"\nError while opening the file\n";goto b;
		}
		else
		{
			...
			cout<<"\n";
			pat_file.close();
			pat_file.open(firstname, ios::out | ios::app);
            cout<<"\n";
...
if(i==3)
{
	...
	pat_file.open(firstname, ios::in);
		...
		{
		    cout<<"\n\n\n\n\t\t\t\t........................................ Full Medical History of "<<firstname<<" ........................................\n\n\n\n";
		    string info;
			while(pat_file.good())
			{
			getline(pat_file,info);
